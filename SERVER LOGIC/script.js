...
getArticle("15");
removeArticle("21");
console.log(editArticle("2",{author:"Andrew Rumiantsev", undefined}));
sortArticles(articles);
console.log(articles);
console.log(getArticles(undefined,undefined,authorFilter|dateFilter|tagFilter,"MIX","2017",["TECH","FACEBOOK"]));